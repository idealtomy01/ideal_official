    ...
    <div className="min-h-screen bg-black text-gray-100">
      ...
      <header className="fixed top-16 left-0 w-full z-40 shadow-xl border-b border-gray-700 bg-black/80 backdrop-blur-md">
        <div className={`${layout.container} py-4 flex flex-wrap justify-center sm:justify-between items-center`}>
          ...
          <nav className="flex flex-wrap justify-center space-x-4 text-sm font-medium">
            <a href="#vision" className="nav-link hover:text-blue-400 transition-colors duration-300">0. Vision</a>
            <a href="#conflict" className="nav-link hover:text-blue-400 transition-colors duration-300">1. Conflict</a>
            <a href="#philosophy" className="nav-link hover:text-blue-400 transition-colors duration-300">2. Philosophy</a>
            <a href="#mechanism" className="nav-link hover:text-blue-400 transition-colors duration-300">3. Mechanism</a>
            <a href="#structure" className="nav-link hover:text-blue-400 transition-colors duration-300">4. Structure</a>
            <a href="#path" className="nav-link hover:text-blue-400 transition-colors duration-300">5. Path</a>
            <a href="#declaration" className="nav-link hover:text-blue-400 transition-colors duration-300">6. Declaration</a>
          </nav>
        </div>
      </header>
      ...
      <main className="pt-48 md:pt-40 pb-16">
        <div className={`${layout.containerNarrow}`}>
          ...
          <section className="text-center mb-4 md:mb-8">
            <hgroup>
              <p className="text-xs tracking-widest uppercase mb-2">Whitepaper v1.0</p>
              <h2 className={`text-3xl md:text-5xl font-extrabold ${colors.accent.primary} mb-2`}>
                自由と秩序が両立した社会を設計する
              </h2>
            ...
            <div className="h-1 bg-gray-700 w-1/3 mx-auto mt-6 rounded-full"></div>
          </section>
          ...
          <section id="conflict" className="py-8 md:py-16 border-b border-gray-800">
            ...
            <div className="mb-12 p-6 md:p-8 rounded-xl bg-gray-900 shadow-2xl border border-gray-700">
              ...
              <div className="grid grid-cols-1 md:grid-cols-5 gap-4 items-center">
                ...
                <div className="col-span-1 md:col-span-2 p-4 md:p-6 border-2 border-gray-600 rounded-xl text-center bg-gray-800 h-full flex flex-col justify-center">
                  <svg className="w-10 h-10 text-blue-400 mx-auto mb-3" fill="structural" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* 第2章：歪められた価値の再定義（The Philosophy） */}
          ...
          <section id="mechanism" className="py-8 md:py-16 border-b border-gray-800">
            ...
            <div className="space-y-6 text-base md:text-lg leading-relaxed mb-12">
              <p>
                設計思想の中心は<strong>&ldquo;貢献度測定（Proof of Contribution）&rdquo;</strong>に集約されます。
                これまで測定が難しかった本質的価値の測定や、&ldquo;本質的価値と評価基準の明確化&rdquo;こそが、
                所属している全ての人の行動原理となり、結果、組織全体の原動力となるからです。
              </p>
              <p>
                人間による評価は、リソースの限界と避けられないバイアスにより、実現したくても実現できないことによる不公平と搾取の温床となってしまっていました。
                私たちは、この&ldquo;人間とこれまでの技術よる評価の限界&rdquo;を、<strong>AIとブロックチェーンが永続的に連携する&ldquo;貢献度測定ツール&rdquo;</strong>によって実現することを目指します。
              </p>
            </div>
